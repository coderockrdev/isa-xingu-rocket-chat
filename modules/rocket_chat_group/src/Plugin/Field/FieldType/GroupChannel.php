...
//    // Some fields above.
//
//    $fields['value'] = BaseFieldDefinition::create('channelName')
//      ->setLabel(t('Channel Name'))
//      ->setDescription(t("Channel name to use in the chat environment.<br>like: #&lt;GroupName&gt;<br><mark>When missing no channel association will be done!</mark>"))
...
//    drupal_set_message("Value:=" . json_encode($value));
//    $ret =  $this->value;
//    return $value;
//  }
...
//      $ret = parent::onChange($property_name,$notify);
//      echo "t";
//      return $ret;
//    }
